...
class Truck:
    ...
    def deliver_packages(self, departure_time, package_handler, package_status_over_time, package_9_has_been_updated):
        ...
        # in_transit_begin is used for the time when packages became "enroute"
        ...
        while (self.delivery_route.qsize() > 0):
            ...
            if (current_time >= ten_twenty_am and not package_9_has_been_updated and self.id == "1_trip2" and not dont_ask_to_update_9):
                print("")
                print(f"\tDuring delivery, new information has come in about package #9!")
                print(f"\tWould you like to correct the address for package #9? Enter 'y' or 'n'")
                print("")

                answer = input(">")
                # Fix Package #9
                while (answer != "y" and answer != "n"):
                    print(f"\tInvalid Response. " + "During the route, new information has come in about package #9!")
                    print(f"\tWould you like to correct the address for package #9? Enter 'y' or 'n'" )
                    answer = input(">")
                ...
                if (answer == "y"):
                    ...
                    print(f"\tPackage #9's address has been updated to: 410 S State St., Salt Lake City, UT 84111!")
                    print("")
                    sleep(1)
